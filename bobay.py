...
Bots = ["uf41eeac6f34ebb531b1acba159203dea","u0e495c4debaa244e5f61f4e090950f75"]
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"BOBBOT PROTECT FREE ! Creator by: line: bobtndm ",
    "lang":"JP",
    ...
    try:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'uf41eeac6f34ebb531b1acba159203dea': kimid}
                ki.sendMessage(msg) 
                msg.contentType = 13
                           ...
                           for target in targets:                            
                             if not target in Bots:
                                if not target in admin:
                                  try:
                                      klist=[cl,ki,ki2] #ki,ki2,ki3,ki4,ki5,ki6,ki7,ki8,ki9,w1,w2,w3,w4,w5]
                                      kicker=random.choice(klist)
                                      kicker.kickoutFromGroup(msg.to,[target])
                                      print (msg.to,[g.mid])
                                  except:
                                      cl.sendText(msg.to,"Sukses Bosqu")
                                      cl.sendText(msg.to,"Sudah ditendang hehe")
